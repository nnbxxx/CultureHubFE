...
const ModalEditBook = (props) => {
  ...
  const { data, setData, fetchListBook } = props;
  ...
  const onFinish = async (values) => {
    ...
    setIsSubmit(true);
    const res = await callPutUpdateBook(
      data._id,
      dataThumbnail[0].name ? dataThumbnail[0].name : dataThumbnail[0],
      sliderImgName,
      mainText,
      author,
      price,
  ...
  const handleUploadFileThumbnail = async ({ file, onSuccess, onError }) => {
    ...
    if (res && res.data) {
      ...
      onError("An error occuring when upload file");
    }
  };
  ...
  useEffect(() => {
    form.setFieldsValue(data);
    setDataThumbnail(data.thumbnail);
            ...
            <Col span={12}>
              ...
              >
                <Upload
                  ...
                  defaultFileList={fileListThumbnail}
                >
                  <div>
                    <PlusOutlined />
            ...
            <Col span={12}>
              ...
              >
                <Upload
                  ...
                  onPreview={handlePreview}
                  defaultFileList={fileListSlider}
                >
                  <div>
                    <PlusOutlined />
                    <div style={{ marginTop: 8 }}>Upload</div>
